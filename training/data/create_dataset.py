...
processed_dataset_dict["train"].to_json(f"{dataset_name}_{dataset_split.lower()}_train.json")
processed_dataset_dict["test"].to_json(f"{dataset_name}_{dataset_split.lower()}_test.json")
